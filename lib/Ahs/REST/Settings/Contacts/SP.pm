package Ahs::REST::Settings::Contacts::SP;
use strict;
use Ahs::REST::Settings::Contacts::Backend;
use Ahs::REST::Settings::Contacts::Map;
use Ahs::REST::Engine;
use Ahs::REST::View;
...
sub service_object {
    ...
    my $backend = Ahs::REST::Settings::Contacts::Backend->new(
        {
            model     => $env->{model},
    ...
    my $rest = Ahs::REST::Engine->new(
        {
            map       => Ahs::REST::Settings::Contacts::Map->get_map,
            backend   => $backend,
            view      => $view,
            session   => $env->{session},
            model     => $env->{model},
...
=head1 Ahs::REST::Settings::Contacts
