package Ahs::REST::Settings::Media::Map;
use strict;

my $map = [
    {
        # regexp or absolute value for url to service
        regexp    => '/ahs/settings/media',
        ...
        in        => {
            ...
            param         => [
                ...
                { name => 'media',     rules => [ {rule => 'anyText' } ], required => 1,error => "Bad value for 'media'" },
            ]
        },
...
=head1 REST::Ahs::REST::Settings::Media::Map - [TODO]
