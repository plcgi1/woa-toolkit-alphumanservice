package Ahs::REST::Participants::SP;
use strict;
use Ahs::REST::Participants::Backend;
use Ahs::REST::Participants::Map;
use Ahs::REST::Engine;
use Ahs::REST::View;
...
sub service_object {
    ...
    my $backend = Ahs::REST::Participants::Backend->new(
        {
            model     => $env->{model},
    ...
    my $rest = Ahs::REST::Engine->new(
        {
            map       => Ahs::REST::Participants::Map->get_map,
            backend   => $backend,
            view      => $view,
            session   => $env->{session},
            model     => $env->{model},
