package Ahs::REST::Participants::Map;
use strict;

my $map = [
    {
        # regexp or absolute value for url to service
        regexp    => '/ahs/participants$',
        ...
        in        => {
            ...
            param         => [
                ...
                { name => 'project_id',    rules => [ {rule => 'integer' } ], error => "Bad value for 'project_id'" },
...
=head1 REST::Ahs::REST::Participants::Map - [TODO]
