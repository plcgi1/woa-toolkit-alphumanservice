package Alproute::REST::RouteManager::SP;
use strict;
use Alproute::REST::RouteManager::Backend;
use Alproute::REST::RouteManager::Map;
use Alproute::REST::Engine;
...
sub service_object {
    ...
    my $backend = Alproute::REST::RouteManager::Backend->new(
        {
            model     => $env->{model},
    ...
    my $rest = Alproute::REST::Engine->new(
        {
...
=head1 Alproute::REST::RouteManager
