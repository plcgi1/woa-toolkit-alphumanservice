package Alphumanservice::REST::Project::SP;
use strict;
use Alphumanservice::REST::Project::Backend;
use Alphumanservice::REST::Project::Map;
...
sub service_object {
    ...
    my $backend = Alphumanservice::REST::Project::Backend->new(
        {
            model     => $env->{model},
    ...
    my $rest = Alphumanservice::REST::Engine->new(
        {
            map       => Alphumanservice::REST::Project::Map->get_map,
            backend   => $backend,
            view      => $view,
            session   => $env->{session},
            model     => $env->{model},
...
=head1 Alphumanservice::REST::Project
