package Alphumanservice::REST::DischargeData::Map;
use strict;

my $map = [
    {
        # regexp or absolute value for url to service
        regexp    => '/ahs/discharge',
        ...
        in        => {
            ...
            param         => [
                ...
                { name => 'discharge',  rules => [ {rule => 'anyText' } ], required => 1,error => "Bad value for 'discharge'" },
            ]
        },
...
=head1 REST::Alphumanservice::REST::DischargeData::Map - [TODO]
