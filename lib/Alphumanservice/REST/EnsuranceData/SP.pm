package Alphumanservice::REST::EnsuranceData::SP;
use strict;
use Alphumanservice::REST::EnsuranceData::Backend;
...
sub service_object {
    ...
    my $backend = Alphumanservice::REST::EnsuranceData::Backend->new(
        {
            model     => $env->{model},
...
=head1 Alphumanservice::REST::EnsuranceData
