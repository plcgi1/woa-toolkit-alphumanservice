package Alphumanservice::REST::EnsuranceData::Map;
use strict;

my $map = [
    {
        # regexp or absolute value for url to service
        regexp    => '/ahs/ensurance',
        ...
        in        => {
            ...
            param         => [
                ...
                { name => 'date',       rules => [ {rule => 'simple_date_dmy' } ], required => 1,error => "Bad value for 'date'" },
                { name => 'fio',       rules => [ {rule => 'anyText' } ], required => 1,error => "Bad value for 'fio'" },
            ]
        },
...
=head1 REST::Alphumanservice::REST::EnsuranceData::Map - [TODO]
