...
BEGIN { use_ok 'Alphumanservice::REST::Auth::SP' }

Alphumanservice::REST::Auth::Tester->process();

package Alphumanservice::REST::Auth::Tester;
use strict;
use Alphumanservice::REST::Auth::SP;
...
sub set_up {
    ...
    $sp = Alphumanservice::REST::Auth::SP->new;
