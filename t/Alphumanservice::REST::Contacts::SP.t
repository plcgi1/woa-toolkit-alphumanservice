...
BEGIN { use_ok 'Alphumanservice::REST::Contacts::SP' }

Alphumanservice::REST::Contacts::Tester->process();

package Alphumanservice::REST::Contacts::Tester;
use strict;
use Alphumanservice::REST::Contacts::SP;
...
sub set_up {
    ...
    $sp = Alphumanservice::REST::Contacts::SP->new;
