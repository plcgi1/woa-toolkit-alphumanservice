...
BEGIN { use_ok 'Alphumanservice::REST::PassportData::SP' }

Alphumanservice::REST::PassportData::Tester->process();

package Alphumanservice::REST::PassportData::Tester;
use strict;
use Alphumanservice::REST::PassportData::SP;
use Alphumanservice::REST::PassportData::Map;
...
sub set_up {
    ...
    $sp = Alphumanservice::REST::PassportData::SP->new;
    $rest = $sp->service_object();
    $map = Alphumanservice::REST::PassportData::Map::get_map;
