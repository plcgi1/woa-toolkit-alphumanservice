...
BEGIN { use_ok 'Alphumanservice::REST::GeoData::SP' }

Alphumanservice::REST::GeoData::Tester->process();

package Alphumanservice::REST::GeoData::Tester;
use strict;
use Alphumanservice::REST::GeoData::SP;
...
sub set_up {
    ...
    $sp = Alphumanservice::REST::GeoData::SP->new;
