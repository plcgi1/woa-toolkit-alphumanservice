...
BEGIN { use_ok 'Alphumanservice::REST::UserData::SP' }

Alphumanservice::REST::UserData::Tester->process();

package Alphumanservice::REST::UserData::Tester;
use strict;
use Alphumanservice::REST::UserData::SP;
use Alphumanservice::REST::UserData::Map;
...
sub set_up {
    ...
    $sp = Alphumanservice::REST::UserData::SP->new;
    $rest = $sp->service_object();
    $map = Alphumanservice::REST::UserData::Map::get_map;
