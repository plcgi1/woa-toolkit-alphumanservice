...
BEGIN { use_ok 'Alphumanservice::REST::DischargeData::SP' }

Alphumanservice::REST::DischargeData::Tester->process();

package Alphumanservice::REST::DischargeData::Tester;
use strict;
use Alphumanservice::REST::DischargeData::SP;
...
sub set_up {
    ...
    $sp = Alphumanservice::REST::DischargeData::SP->new;
