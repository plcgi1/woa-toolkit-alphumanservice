...
(function($) {
    $.flexbox = function(div, o) {
		...
		var calcLeft = function(o,inputWidth,arrowWidth){
			var res = 0;
			if(o.underTextBox){
				res = -(inputWidth + arrowWidth);
			}
			return res;
		};
		...
		var left = calcLeft(o,inputWidth,arrowWidth);
        var $ctr = $('<div></div>')
...
//DumperAlert(d);
    ...
    $.fn.flexbox.defaults = {
		...
		underTextBox: false, // position for dropdown.If false - dropdown list will be under right bottom of arrow.Else - under text box
        paging: {
